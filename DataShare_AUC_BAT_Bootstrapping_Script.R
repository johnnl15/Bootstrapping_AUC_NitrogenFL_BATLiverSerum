...
BAT<-read.csv("BAT_TotalFractionalNitrogenLabeling.csv")
Serum<-read.csv("Serum_TotalFractionalNitrogenLabeling_ForBAT.csv")
...
boostrapped_result$foldchange<-boostrapped_result$bataverage/boostrapped_result$serumaverage
boostrapped_result$CILower97.5_foldchange<-boostrapped_result$CILower97.5+boostrapped_result$serumaverage
boostrapped_result$CIHigher2.5_foldchange<-boostrapped_result$CIHigher2.5+boostrapped_result$serumaverage
boostrapped_result$CILower97.5_foldchange<-boostrapped_result$CILower97.5_foldchange/boostrapped_result$serumaverage
boostrapped_result$CIHigher2.5_foldchange<-boostrapped_result$CIHigher2.5_foldchange/boostrapped_result$serumaverage
boostrapped_result$Tissue<-"BAT"

write.csv(boostrapped_result,file = "Bootstrapped_Result_BAT.csv",row.names = FALSE)
